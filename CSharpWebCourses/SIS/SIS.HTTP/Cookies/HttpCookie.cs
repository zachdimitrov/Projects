...
namespace SIS.HTTP.Cookies
{
    public class HttpCookie
    {
        ...
        public HttpCookie(string key, string value, int expires = HttpCookieDefaultExpirationDays, string path=HttpCookieDefaultPath):this(key, value, true, expires, path)
        {
        }
